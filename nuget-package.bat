...
msbuild.exe SystemInterface\SystemInterface.csproj /p:Configuration="Release 4.0 Client" /p:Platform="AnyCPU" /t:Build
...
msbuild.exe SystemWrapper\SystemWrapper.csproj /p:Configuration="Release 4.0 Client" /p:Platform="AnyCPU" /t:Build
